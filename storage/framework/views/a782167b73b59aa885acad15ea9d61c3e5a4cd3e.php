<?php echo e(Form::model($employee, array('route' => array('employee.update', $employee->id), 'method' => 'PUT'))); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('skills', null, array('class'=>'form-control', 'placeholder'=>__('Enter Skills')))); ?>
        ...
        <div class="form-group col-md-6">
         ...
         <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('status', ['1' => 'Active', '0' => 'Inactive'], null, array('class'=>'form-control'))); ?>
...
<?php /**PATH /media/manmohan/D25CA17B5CA15ACD/code&projectsDOC/2081/migration-tracking-system/resources/views/employee/edit.blade.php ENDPATH**/ ?>