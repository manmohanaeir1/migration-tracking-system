{{Form::open(array('url'=>'employee','method'=>'post', 'enctype' => "multipart/form-data"))}}
    ...
    <div class="row">
        <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-6">
            ...
            {{ Form::textarea('skills', null, array('class'=>'form-control', 'rows'=>3, 'placeholder'=>__('Enter Remarks'))) }}
          </div>
          <div class="form-group col-md-6">
