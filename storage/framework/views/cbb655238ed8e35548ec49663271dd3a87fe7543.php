...
<head>
    ...
    <!-- shortcut icon-->
    <link rel="icon" href="<?php echo e(asset(url('upload/logo')).'/'.$settings['company_favicon']); ?>" type="image/x-icon">
...
<?php /**PATH /media/manmohan/D25CA17B5CA15ACD/code&projectsDOC/2081/migration-tracking-system/resources/views/admin/head.blade.php ENDPATH**/ ?>