            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            {{Form::label('parking_number_prefix',__('Parking Number Prefix'),array('class'=>'form-label')) }}
                            {{Form::text('parking_number_prefix',$settings['parking_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter parking number prefix')))}}
