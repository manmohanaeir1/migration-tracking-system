                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s"><?php echo e(__('EasyPark - Vehicle Parking Management System')); ?></h1>
                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    ...
                                    <p><?php echo e(__('EasyPark system integrates technology to efficiently manage parking spaces, enhance user experience, and enforce rules and regulations.')); ?></p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Parking Zone')); ?></h5>
                                    <p><?php echo e(__('EasyPark system integrates technology to efficiently manage parking spaces, enhance user experience, and enforce rules and regulations.')); ?></p>
                                </a>
                            </div>
                        </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Parking Details')); ?></h5>
                                    <p><?php echo e(__('EasyPark system integrates technology to efficiently manage parking spaces, enhance user experience, and enforce rules and regulations.')); ?></p>
                                </a>
                            </div>
                        </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Parking Slot')); ?></h5>
                                    <p><?php echo e(__('EasyPark system integrates technology to efficiently manage parking spaces, enhance user experience, and enforce rules and regulations.')); ?></p>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        ...
                        <ul class="cdxprice-list">
                            ...
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i><?php echo e($subscription->parking_zone_limit); ?></span><?php echo e(__('Zone Limit')); ?></li>
                            <li>
...
<?php /**PATH /media/manmohan/D25CA17B5CA15ACD/code&projectsDOC/2081/tracking/resources/views/layouts/landing.blade.php ENDPATH**/ ?>