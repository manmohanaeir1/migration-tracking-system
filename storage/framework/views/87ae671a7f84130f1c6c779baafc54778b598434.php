...
<?php $__env->startSection('card-action-btn'); ?>
    <?php if(Gate::check('create employee')): ?>
        <?php if(Auth::user()->hasRole('super admin') || !Auth::user()->employees()->exists()): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manmohan/Desktop/migration-tracking-system/resources/views/employee/index.blade.php ENDPATH**/ ?>