<?php echo e(Form::model($parking, array('route' => array('parking.update', $parking->id), 'method' => 'PUT'))); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            <?php echo e(Form::label('vehicle_number',__('Vehicle Number'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('vehicle_number',null,array('class'=>'form-control','placeholder'=>__('Enter vehicle number')))); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="hidden" id="edit_type" value="<?php echo e($parking->type); ?>">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="hidden" id="edit_floor" value="<?php echo e($parking->floor); ?>">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="hidden" id="edit_slot" value="<?php echo e($parking->slot); ?>">
            <div class="slot_dive">
                <select class="form-control hidesearch slot" id="slot" name="slot">
                    <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($k); ?>" <?php echo e($k==$parking->slot?'selected':''); ?>><?php echo e($slot); ?></option>
        ...
        <div class="form-group  col-md-6">
            <?php echo e(Form::label('entry_date',__('Entry Date'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::date('entry_date',date('Y-m-d'),array('class'=>'form-control'))); ?>

        </div>
        <div class="form-group  col-md-6">
            <?php echo e(Form::label('entry_time',__('Entry Time'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::time('entry_time',date('H:i'),array('class'=>'form-control'))); ?>
...
<script>
    ...
    $('#floor_id').on('change', function () {
        ...
        var url = '<?php echo e(route("parking.zone.floor.slot", [":floor_id",":zone_id",":type_id"])); ?>';
...
<?php /**PATH /media/manmohan/D25CA17B5CA15ACD/code&projectsDOC/2081/tracking/resources/views/parking/edit.blade.php ENDPATH**/ ?>