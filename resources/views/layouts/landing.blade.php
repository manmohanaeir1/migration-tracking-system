        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>{{__('Installation Questions')}}</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    {{__('What are the system requirements for installation?')}}
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#install-que">
                                <div class="accordion-body">
                                    {{__('The system requires a web server with PHP 7.4 or higher, a MySQL database, and a modern web browser. Detailed requirements can be found in the documentation.')}}
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    {{__('How do I install the migration tracking system?')}}
                                </button>
                            </h2>
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#install-que">
                                <div class="accordion-body">
                                    {{__('To install the migration tracking system, follow the steps outlined in the installation guide. This includes downloading the package, setting up the database, and configuring the environment settings.')}}
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    {{__('Can I install the system on a shared hosting environment?')}}
                                </button>
                            </h2>
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#install-que">
                                <div class="accordion-body">
                                    {{__('Yes, the system can be installed on a shared hosting environment as long as it meets the system requirements. Please refer to the documentation for specific instructions.')}}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                    {{__('What is the migration tracking system?')}}
                                </button>
                            </h2>
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#general-que">
                                <div class="accordion-body">
                                    {{__('The migration tracking system is a tool designed to help organizations track and manage the migration of employees or individuals to different locations. It provides features for tracking migration status, managing documents, and generating reports.')}}
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                    {{__('How do I add a new employee to the system?')}}
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#general-que">
                                <div class="accordion-body">
                                    {{__('To add a new employee, navigate to the "Employees" section and click on "Add New Employee". Fill in the required details and save the information. The new employee will be added to the system.')}}
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSix">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                    {{__('Can I generate reports from the system?')}}
                                </button>
                            </h2>
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#general-que">
                                <div class="accordion-body">
                                    {{__('Yes, the system provides various reporting features. You can generate reports on migration status, employee details, and other relevant data. Navigate to the "Reports" section to access these features.')}}
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSeven">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                    {{__('Is there a user manual available?')}}
                                </button>
                            </h2>
                            <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#general-que">
                                <div class="accordion-body">
                                    {{__('Yes, a comprehensive user manual is available in the documentation section. It provides detailed instructions on how to use the system and its various features.')}}
                                </div>
                            </div>
                        </div>
                    </div>
