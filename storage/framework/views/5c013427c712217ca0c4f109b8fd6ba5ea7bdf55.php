            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('parking_number_prefix',__('Parking Number Prefix'),array('class'=>'form-label'))); ?>

                            <?php echo e(Form::text('parking_number_prefix',$settings['parking_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter parking number prefix')))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/manmohan/D25CA17B5CA15ACD/code&projectsDOC/2081/tracking/resources/views/settings/company.blade.php ENDPATH**/ ?>